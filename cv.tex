...
\begin{tabular}{rl}
    ...
    \textsc{Address:}   & Vale Grou de Cima, 4 \sbull 2815-658 Sobreda de Caparica, Portugal \\
...
\textsc{February} 2010 & \textbf{Faculdade de Ciências e Tecnologia - UNL}, Caparica, Portugal\\
- \textsc{March} 2014 & \small \textbf{Bachelor's degree in Computer Science \& Engineering}\\
& \small Finished with a grade point average of 17/20.\\
...
\textsc{September} 2002 & \textbf{Escola Secundária Fernão Mendes Pinto}, Almada, Portugal\\
- \textsc{July} 2008 & \small \textbf{Science and Technology} (pre-university secondary education)\\
...
\begin{tabular}{rp{11cm}}
 \textsc{May} 2014 & M101JS: MongoDB for Node.js Developers\\
\textsc{August} 2011 & Certificate of Proficiency in English (CPE)\\
& \small Grade B\\
